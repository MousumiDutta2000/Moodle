...
class __Mustache_35a68246b3e4bfd74e55fb7cf684ddaf extends Mustache_Template
{
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawerheading' => array($this, 'blockFa7080201d38fffa8ff4e582054fc220'),
                        'drawercontent' => array($this, 'blockDf0c0239c7dd35490126de716827cfc5'),
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('theme_boost/drawer')) {
                    $context->pushBlockContext(array(
                        ...
                        'drawercontent' => array($this, 'block14535f18d901b741a524d1ed4d61cd77'),
...
';
    ...
    public function blockFa7080201d38fffa8ff4e582054fc220($context)
    {
        $indent = $buffer = '';
        $buffer .= '                ';
        // 'str' section
...
';
    ...
    public function blockDf0c0239c7dd35490126de716827cfc5($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '                ';
...
';
    ...
    public function block14535f18d901b741a524d1ed4d61cd77($context)
    {
        $indent = $buffer = '';
